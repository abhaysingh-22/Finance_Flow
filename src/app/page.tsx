...
export default function DashboardPage() {
  ...
  return (
    <>
      ...
      <main className="flex-1 p-4 md:p-6 lg:p-8 space-y-6 md:space-y-8 bg-background overflow-auto">
        <div className="mb-6 md:mb-8">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div className="space-y-1">
              <h2 className="text-2xl sm:text-3xl lg:text-4xl font-semibold text-foreground font-headline tracking-tight">
        ...
        <section 
          ...
          className="rounded-xl animate-in fade-in slide-in-from-bottom-4 duration-500 delay-400"
        >
